...
I[1][2]='1';
I[1][3]=new Array();
I[1][3][0]=new Array('a lot','',1,100,1);
I[1][3][1]=new Array('tons','',1,100,1);
I[1][3][2]=new Array('most of it','',1,100,1);
I[1][3][3]=new Array('bunches','',1,100,1);
I[2]=new Array();I[2][0]=100;
I[2][1]='';
I[2][2]='1';
I[2][3]=new Array();
I[2][3][0]=new Array('Telling the future in advance','',1,100,1);
I[2][3][1]=new Array('Telling the future in advance.','',1,100,1);
I[2][3][2]=new Array('telling the future in advance','',1,100,1);
I[2][3][3]=new Array('telling the future ahead of time','',1,100,1);
...
var ResultForm = '<html><body><form name="Results" action="/public_html/cgi-bin/FormMail.pl" method="post" enctype="x-www-form-encoded">';
